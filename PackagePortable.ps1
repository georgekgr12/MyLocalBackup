...
$version = (Select-String -Path "MyLocalBackup.UI/MyLocalBackup.UI.csproj" -Pattern "<Version>(.*)</Version>").Matches.Groups[1].Value
...
Get-ChildItem -Path $stagingDir -Filter "*.pdb" | Remove-Item
